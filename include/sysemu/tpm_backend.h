...
struct TPMBackendClass {
    ...
    /* locality 4 restricted operations */
    int (*start_hash)(TPMBackend *t);

    int (*hash_data) (TPMBackend *t, uint8_t * data_p, size_t dsize);

    int (*end_hash) (TPMBackend *t);
...
void tpm_backend_hash_start(TPMBackend *s);

void tpm_backend_hash_data(TPMBackend *s, uint8_t* data, size_t sdata);

void tpm_backend_hash_end(TPMBackend *s);
