...
typedef u16                          TPM_ALG_ID;
#define TYPE_OF_TPM_ALG_ID              u16
...
typedef u16              TPM_ECC_CURVE;
#define TYPE_OF_TPM_ECC_CURVE   u16
...
typedef u32              TPM_ALGORITHM_ID;
#define TYPE_OF_TPM_ALGORITHM_ID    u32
typedef u32              TPM_MODIFIER_INDICATOR;
#define TYPE_OF_TPM_MODIFIER_INDICATOR  u32
typedef u32              TPM_AUTHORIZATION_SIZE;
#define TYPE_OF_TPM_AUTHORIZATION_SIZE  u32
typedef u32              TPM_PARAMETER_SIZE;
#define TYPE_OF_TPM_PARAMETER_SIZE  u32
typedef u16              TPM_KEY_SIZE;
#define TYPE_OF_TPM_KEY_SIZE    u16
typedef u16              TPM_KEY_BITS;
#define TYPE_OF_TPM_KEY_BITS    u16

/* Table 2:6 - Definition of TPM_SPEC Constants */
typedef  u32             TPM_SPEC;
#define TYPE_OF_TPM_SPEC        u32
...
typedef u32			TPM_CONSTANTS32;
#define TYPE_OF_TPM_CONSTANTS32 u32
...
typedef  u8               TPM_CLOCK_ADJUST;
#define TYPE_OF_TPM_CLOCK_ADJUST    u8
...
typedef u32             TPM_PT_PCR;
#define TYPE_OF_TPM_PT_PCR          u32
...
#define TYPE_OF_TPM_HANDLE  u32

/* Table 2:27 - Definition of TPM_HT Constants  */
typedef u8              TPM_HT;
#define TYPE_OF_TPM_HT          u8
...
#define  HR_TRANSIENT            (TPM_HC)(((u32)TPM_HT_TRANSIENT<<HR_SHIFT))  /* libtpms cast (ubsan) */
#define  HR_PERSISTENT           (TPM_HC)(((u32)TPM_HT_PERSISTENT<<HR_SHIFT)) /* libtpms cast (ubsan) */
...
#define TYPE_OF_TPMA_ALGORITHM  u32
#define TPMA_ALGORITHM_TO_u32(a)  (*((u32 *)&(a)))
#define u32_TO_TPMA_ALGORITHM(a)  (*((TPMA_ALGORITHM *)&(a)))

#define TPMA_ALGORITHM_TO_BYTE_ARRAY(i, a)				\
	            u32_TO_BYTE_ARRAY((TPMA_ALGORITHM_TO_u32(i)), (a))

#define BYTE_ARRAY_TO_TPMA_ALGORITHM(i, a)				\
    {u32 x = BYTE_ARRAY_TO_u32(a);				\
	i = u32_TO_TPMA_ALGORITHM(x);				\
    }
...
#define TYPE_OF_TPMA_OBJECT u32
#define TPMA_OBJECT_TO_u32(a)     (*((u32 *)&(a)))
#define u32_TO_TPMA_OBJECT(a)     (*((TPMA_OBJECT *)&(a)))
#define TPMA_OBJECT_TO_BYTE_ARRAY(i, a)				\
    u32_TO_BYTE_ARRAY((TPMA_OBJECT_TO_u32(i)), (a))
#define BYTE_ARRAY_TO_TPMA_OBJECT(i, a)					\
    { u32 x = BYTE_ARRAY_TO_u32(a); i = u32_TO_TPMA_OBJECT(x); }
...
#define TYPE_OF_TPMA_SESSION    u8
#define TPMA_SESSION_TO_u8(a)     (*((u8 *)&(a)))
#define u8_TO_TPMA_SESSION(a)     (*((TPMA_SESSION *)&(a)))
#define TPMA_SESSION_TO_BYTE_ARRAY(i, a)                                           \
            u8_TO_BYTE_ARRAY((TPMA_SESSION_TO_u8(i)), (a))
#define BYTE_ARRAY_TO_TPMA_SESSION(i, a)                                           \
            { u8 x = BYTE_ARRAY_TO_u8(a); i = u8_TO_TPMA_SESSION(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#define TYPE_OF_TPMA_LOCALITY   u8
#define TPMA_LOCALITY_TO_u8(a)    (*((u8 *)&(a)))
#define u8_TO_TPMA_LOCALITY(a)    (*((TPMA_LOCALITY *)&(a)))
#define TPMA_LOCALITY_TO_BYTE_ARRAY(i, a)                                          \
            u8_TO_BYTE_ARRAY((TPMA_LOCALITY_TO_u8(i)), (a))
#define BYTE_ARRAY_TO_TPMA_LOCALITY(i, a)                                          \
            { u8 x = BYTE_ARRAY_TO_u8(a); i = u8_TO_TPMA_LOCALITY(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#define TYPE_OF_TPMA_PERMANENT  u32
#define TPMA_PERMANENT_TO_u32(a)  (*((u32 *)&(a)))
#define u32_TO_TPMA_PERMANENT(a)  (*((TPMA_PERMANENT *)&(a)))
#define TPMA_PERMANENT_TO_BYTE_ARRAY(i, a)				\
	            u32_TO_BYTE_ARRAY((TPMA_PERMANENT_TO_u32(i)), (a))
#define BYTE_ARRAY_TO_TPMA_PERMANENT(i, a)				\
    {u32 x = BYTE_ARRAY_TO_u32(a);				\
	i = u32_TO_TPMA_PERMANENT(x);				\
    }
...
#define TYPE_OF_TPMA_STARTUP_CLEAR  u32
#define TPMA_STARTUP_CLEAR_TO_u32(a)  (*((u32 *)&(a)))
#define u32_TO_TPMA_STARTUP_CLEAR(a)  (*((TPMA_STARTUP_CLEAR *)&(a)))
#define TPMA_STARTUP_CLEAR_TO_BYTE_ARRAY(i, a)				\
    u32_TO_BYTE_ARRAY((TPMA_STARTUP_CLEAR_TO_u32(i)), (a))
#define BYTE_ARRAY_TO_TPMA_STARTUP_CLEAR(i, a)				\
    {u32 x = BYTE_ARRAY_TO_u32(a);				\
	i = u32_TO_TPMA_STARTUP_CLEAR(x);				\
    }
...
typedef u32                          TPMA_STARTUP_CLEAR;
#define TYPE_OF_TPMA_STARTUP_CLEAR      u32
...
#define TYPE_OF_TPMA_MEMORY u32
#define TPMA_MEMORY_TO_u32(a)     (*((u32 *)&(a)))
#define u32_TO_TPMA_MEMORY(a)     (*((TPMA_MEMORY *)&(a)))
#define TPMA_MEMORY_TO_BYTE_ARRAY(i, a)                                            \
            u32_TO_BYTE_ARRAY((TPMA_MEMORY_TO_u32(i)), (a))
#define BYTE_ARRAY_TO_TPMA_MEMORY(i, a)                                            \
            { u32 x = BYTE_ARRAY_TO_u32(a); i = u32_TO_TPMA_MEMORY(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#define TYPE_OF_TPMA_CC     u32
#define TPMA_CC_TO_u32(a)     (*((u32 *)&(a)))
#define u32_TO_TPMA_CC(a)     (*((TPMA_CC *)&(a)))
#define TPMA_CC_TO_BYTE_ARRAY(i, a)                                                \
            u32_TO_BYTE_ARRAY((TPMA_CC_TO_u32(i)), (a))
#define BYTE_ARRAY_TO_TPMA_CC(i, a)                                                \
            { u32 x = BYTE_ARRAY_TO_u32(a); i = u32_TO_TPMA_CC(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#define TYPE_OF_TPMA_MODES  u32
#define TPMA_MODES_TO_u32(a)  (*((u32 *)&(a)))
#define u32_TO_TPMA_MODES(a)  (*((TPMA_MODES *)&(a)))
#define TPMA_MODES_TO_BYTE_ARRAY(i, a)                                             \
            u32_TO_BYTE_ARRAY((TPMA_MODES_TO_u32(i)), (a))
#define BYTE_ARRAY_TO_TPMA_MODES(i, a)                                             \
            { u32 x = BYTE_ARRAY_TO_u32(a); i = u32_TO_TPMA_MODES(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#define TYPE_OF_TPMA_X509_KEY_USAGE u32
#define TPMA_X509_KEY_USAGE_TO_u32(a)     (*((u32 *)&(a)))
#define u32_TO_TPMA_X509_KEY_USAGE(a)     (*((TPMA_X509_KEY_USAGE *)&(a)))
#define TPMA_X509_KEY_USAGE_TO_BYTE_ARRAY(i, a)				\
    u32_TO_BYTE_ARRAY((TPMA_X509_KEY_USAGE_TO_u32(i)), (a))
#define BYTE_ARRAY_TO_TPMA_X509_KEY_USAGE(i, a)				\
    {u32 x = BYTE_ARRAY_TO_u32(a);				\
	i = u32_TO_TPMA_X509_KEY_USAGE(x);				\
    }
#if USE_BIT_FIELD_STRUCTURES
...
typedef u32                                  TPMA_X509_KEY_USAGE;
#define TYPE_OF_TPMA_X509_KEY_USAGE             u32
...
#define TYPE_OF_TPMA_ACT    u32
#define TPMA_ACT_TO_u32(a)    (*((u32 *)&(a)))
#define u32_TO_TPMA_ACT(a)    (*((TPMA_ACT *)&(a)))
#define TPMA_ACT_TO_BYTE_ARRAY(i, a)					\
    u32_TO_BYTE_ARRAY((TPMA_ACT_TO_u32(i)), (a))
#define BYTE_ARRAY_TO_TPMA_ACT(i, a)					\
    { u32 x = BYTE_ARRAY_TO_u32(a); i = u32_TO_TPMA_ACT(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#endif   // ALG_SM3_256
#if ALG_SHA3_256
    u8                   sha3_256[SHA3_256_DIGEST_SIZE];
#endif // ALG_SHA3_256
#if ALG_SHA3_384
    u8                   sha3_384[SHA3_384_DIGEST_SIZE];
#endif // ALG_SHA3_384
#if ALG_SHA3_512
    u8                   sha3_512[SHA3_512_DIGEST_SIZE];
#endif // ALG_SHA3_512
} TPMU_HA;
...
typedef union {
    struct {
	u16                  size;
	u8                   attestationData[sizeof(TPMS_ATTEST)];
    }            t;
    TPM2B        b;
} TPM2B_ATTEST;
...
typedef union {
    struct {
	u16                  size;
	u8                   buffer[sizeof(TPMU_SENSITIVE_CREATE)];
    }            t;
    TPM2B        b;
...
#define RSA_PRIVATE_SIZE ((MAX_RSA_KEY_BYTES / 2) * 5)
typedef union {
    struct {
	u16                  size;
	u8                   buffer[RSA_PRIVATE_SIZE];
    }            t;
    TPM2B        b;
} TPM2B_PRIVATE_KEY_RSA;
/* Table 2:168 - Definition of TPM2B_ECC_PARAMETER Structure  */
#ifndef MAX_ECC_KEY_BYTES
#define MAX_ECC_KEY_BYTES 80
#endif
typedef union {
    struct {
	u16                  size;
...
typedef union {
#if 	ALG_ECC
    u8                   ecc[sizeof(TPMS_ECC_POINT)];
#endif   // ALG_ECC
#if 	ALG_RSA
    u8                   rsa[MAX_RSA_KEY_BYTES];
#endif   // ALG_RSA
#if 	ALG_SYMCIPHER
    u8                   symmetric[sizeof(TPM2B_DIGEST)];
#endif   // ALG_SYMCIPHER
#if 	ALG_KEYEDHASH
    u8                   keyedHash[sizeof(TPM2B_DIGEST)];
#endif   // ALG_KEYEDHASH
...
typedef union {
    struct {
	u16                  size;
	u8                   secret[sizeof(TPMU_ENCRYPTED_SECRET)];
    }            t;
    TPM2B        b;
...
typedef union {
    struct {
	u16                  size;
	u8                   buffer[sizeof(TPMT_PUBLIC)];
    }            t;
    TPM2B        b;
} TPM2B_TEMPLATE;
/* Table 2:194 - Definition of TPM2B_PRIVATE_VENDOR_SPECIFIC Structure  */
#ifndef PRIVATE_VENDOR_SPECIFIC_BYTES
#define PRIVATE_VENDOR_SPECIFIC_BYTES 960
#endif

typedef union {
    struct {
	u16                  size;
	u8                   buffer[PRIVATE_VENDOR_SPECIFIC_BYTES];
    }            t;
    TPM2B        b;
...
typedef union {
    struct {
	u16                  size;
	u8                   credential[sizeof(TPMS_ID_OBJECT)];
    }            t;
    TPM2B        b;
} TPM2B_ID_OBJECT;

#define TYPE_OF_TPM_NV_INDEX    u32
#define TPM_NV_INDEX_TO_u32(a)    (*((u32 *)&(a)))
#define u32_TO_TPM_NV_INDEX(a)    (*((TPM_NV_INDEX *)&(a)))
#define TPM_NV_INDEX_TO_BYTE_ARRAY(i, a)                                           \
            u32_TO_BYTE_ARRAY((TPM_NV_INDEX_TO_u32(i)), (a))
#define BYTE_ARRAY_TO_TPM_NV_INDEX(i, a)                                           \
            { u32 x = BYTE_ARRAY_TO_u32(a); i = u32_TO_TPM_NV_INDEX(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#define TYPE_OF_TPMA_NV     u32
#define TPMA_NV_TO_u32(a)     (*((u32 *)&(a)))
#define u32_TO_TPMA_NV(a)     (*((TPMA_NV *)&(a)))
#define TPMA_NV_TO_BYTE_ARRAY(i, a)                                                \
            u32_TO_BYTE_ARRAY((TPMA_NV_TO_u32(i)), (a))
#define BYTE_ARRAY_TO_TPMA_NV(i, a)                                                \
            { u32 x = BYTE_ARRAY_TO_u32(a); i = u32_TO_TPMA_NV(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#ifndef MAX_AC_CAPABILITIES
#define MAX_AC_CAPABILITIES 127
#endif
