/* TPM TIS driver file. 
 ...
 Taken directly from the TPM driver implementation for SeaBios (at https://github.com/coreboot/seabios), adapted for OpenSBI.
...
int tpmhw_read_dynamic_buffer(void* respbuffer,
						u32 *respbufferlen, enum tpmDurationType to_t);
...
#define TPM_CRB_BASE_ADDRESS        0x4000000

#define CRB_REG(LOCTY, REG)                                 \
    (void *)(uintptr_t)(TPM_CRB_BASE_ADDRESS + (LOCTY << 12) + REG)
...
#define TPM_TIS_BASE_ADDRESS        0x4000000

#define TIS_REG(LOCTY, REG) \
    (void *)(uintptr_t) (TPM_TIS_BASE_ADDRESS + (LOCTY << 12) + REG)
...
#define TIS_REG_HASH_END 			   0x20
#define TIS_REG_DATA_FIFO              0x24
/* Redundent definition but removes confusion in code */
#define TIS_HASH_DATA_FIFO  		   0x24
#define TIS_REG_HASH_START 			   0x28
#define TIS_REG_IFACE_ID               0x30
#define TIS_REG_DATA_XFIFO 			   0x80
